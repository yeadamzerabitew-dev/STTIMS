...
-- ---------------------------------------------
-- 6. BATCHES  (current_enrollment now explicitly set — fixes the NULL crash)
-- ---------------------------------------------
INSERT INTO batches (
...
-- (e.g. Batch.available_slots doing max_capacity - current_enrollment)
-- =============================================
UPDATE batches SET current_enrollment = 0 WHERE current_enrollment IS NULL;
UPDATE batches SET min_trainees_required = 5 WHERE min_trainees_required IS NULL;
