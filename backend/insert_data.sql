...
-- =============================================
-- INSERT SAMPLE DATA FOR STTIMS
-- =============================================

-- ---------------------------------------------
-- 1. GRADE_SCALE
-- ---------------------------------------------
INSERT IGNORE INTO grade_scale (grade_letter, grade_point, min_percentage, max_percentage, description, is_pass, display_order) VALUES
...
-- 2. CATEGORIES
-- ---------------------------------------------
INSERT IGNORE INTO categories (category_name, category_code, description, icon, display_order, status) VALUES
...
-- ---------------------------------------------
-- 9. ATTENDANCE RECORDS (using recorded_by = 1 for admin)
-- ---------------------------------------------
...
(3, 1, 'Present', '08:55:00', '12:05:00', NULL, 1),
(3, 2, 'Present', '08:58:00', '12:02:00', NULL, 1),
(3, 3, 'Present', '09:00:00', '12:00:00', NULL, 1),
(3, 4, 'Present', '08:50:00', '12:10:00', NULL, 1),
(3, 5, 'Absent', NULL, NULL, 'Still sick', 1);
