#!/usr/bin/env python
"""Complete data seeding for STTIMS"""
...
def seed_all():
    with app.app_context():
        ...
        # =============================================
        # 6. Create Batches (without instructor_id)
        # =============================================
        ...
        for session in sessions[:20]:
            ...
            for enrollment in batch_enrollments[:5]:
        ...
        assessments = []
        assessment_types = ['Quiz', 'Assignment', 'Lab', 'Project', 'Exam']
        ...
        for assessment in assessments[:15]:
            ...
            for enrollment in enrollments_for_batch[:5]:
        ...
        certificates = []
        for enrollment in completed_enrollments[:8]:
